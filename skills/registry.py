...
class SkillMeta:
    """单个技能的元数据描述。"""
    name: str                          # 文件名（不含 .md），如 "1_perception_expert"
...
SKILL_REGISTRY: Dict[str, SkillMeta] = {
    ...
    "3_god_comment_generator": SkillMeta(
        name="3_god_comment_generator",
        display_name="神评论生成器",
        module="modules.comment_generator",
        required_sections=["五种核心风格详解", "Reddit语态大师课"],
        optional_sections=["创意生成框架", "技术实现策略", "输出规范"],
    ),
    "4_visual_prompt_designer": SkillMeta(
        name="4_visual_prompt_designer",
